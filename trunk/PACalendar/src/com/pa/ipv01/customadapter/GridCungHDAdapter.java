...
public class GridCungHDAdapter extends BaseAdapter {
	private ArrayList<String> title;
	private ArrayList<Integer> icon;
	private Activity activity;

	public GridCungHDAdapter(Activity activity, ArrayList<String> title,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			view = new ViewHolder();
			convertView = inflater.inflate(R.layout.griditem_cunghd, null);
