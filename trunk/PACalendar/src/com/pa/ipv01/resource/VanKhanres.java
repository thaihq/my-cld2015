...
public class VanKhanres {
	public static final String letet = "Văn Khấn Lễ Tết";
	public static final String hangthang = "Văn Khấn Hàng Tháng";
	public static final String giatrach = "Văn Khấn Gia Trạch";
	public static final String hieuhy = "Văn Khấn Hiếu Hỷ";
	public static final String cacngaytettrongnam = "Các Ngày Tết Trong Năm";
	public static final String dinhchua = "Đình, Chùa, Miếu Phủ";
	...
	public static final String gttrong = "Khấn Giao Thừa Trong Nhà";
	...
	public static final String cuahang = "Khai Trương Cửa Hàng";
	...
	public static final String trungnguyen = "Tết Trung Nguyên";
	public static final String trunguyen1 = "Tết Trung Nguyên 1";
	public static final String hanthuc = "Tết Hàn Thực";
	public static final String hanguyen = "Tết Hạ Nguyên";
	...
	public static final String chua = "Khấn Tại Chùa";
	public static final String phat = "Khấn Lễ Phật";
	public static final String thanhtran = "Khấn Đức Thánh Trần";
	public static final String thanhhien = "Khấn Đức Thánh Hiền";
	public static final String quanam = "Khấn Phật Bà Quan Âm";
